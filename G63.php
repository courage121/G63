			...
			else if($z2!=0)
			{
				...
				{	//B-1
					...
					if($t0 == true)
					{
						...
						$t3 = $l['bidprice1']+$i*$minmove!=$chengjiao[$z2-1]['p'] || ($chicang==0 && $up["".($l['bidprice1']+$i*$minmove).""]['s']==0);
						$t4 = true;
						$t5 = true;
						$t6 = true;
						$t7 = true;
					...
					if($t100 == true)
					{
						...
						$t103 = $l['askprice1']-$i*$minmove!=$chengjiao[$z2-1]['p'] || ($chicang==0 && $up["".($l['askprice1']-$i*$minmove).""]['b']==0);
						$t104 = true;
						$t105 = true;
						$t106 = true;
						$t107 = true;
					...
					if($t200 == true)
					{
						...
						$t203 = $l['bidprice1']+$i*$minmove<$lowestS;
						$t204 = true;
						$t205 = true;
						$t206 = true;
						$t207 = true;
					...
					if($t300 == true)
					{
						...
						$t303 = $l['askprice1']-$i*$minmove>$highestB;
						$t304 = true;
						$t305 = true;
						$t306 = true;
						$t307 = true;
